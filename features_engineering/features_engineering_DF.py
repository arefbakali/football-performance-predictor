...
class FeatureEngineeringDF:
    ...
    def add_defensive_features(self):
        # Ajouter des colonnes spécifiques aux défenseurs
        self.df_cleaned['Tkl/90'] = self.df_cleaned['Tkl'] / self.df_cleaned['90s']
        self.df_cleaned['Int/90'] = self.df_cleaned['Int'] / self.df_cleaned['90s']
        self.df_cleaned['Blocks/90'] = self.df_cleaned['Blocks'] / self.df_cleaned['90s']
        self.df_cleaned['Clr/90'] = self.df_cleaned['Clr'] / self.df_cleaned['90s']
...
input_file_path = r'C:\Users\Aref Bakali\OneDrive\Bureau\Projet Python\data\cleaned\DF_players.xlsx'  # Remplacer par ton chemin local
output_file_path = r'C:\Users\Aref Bakali\OneDrive\Bureau\Projet Python\data\features\features_DF.xlsx'  # Fichier de sortie
fe = FeatureEngineeringDF(input_file_path)
